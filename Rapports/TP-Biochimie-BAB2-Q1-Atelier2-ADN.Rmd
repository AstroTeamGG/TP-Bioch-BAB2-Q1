...
#### Extraction et précipitation
La première étape de cette expérience était de prélever 10g de thymus de veau (figure 3) pour ensuite le mixer avec un tampon glacé,nous avont préparer 750ml de tampon, préparé préalablement à partir de 6,75g NaCl 0.9% et 2,205g citrate de sodium 0.1M.
...
Comme précédemment détayé dans l'introduction, il existe plusieurs moyens de dénaturer l'ADN. Celui que nous utiliserons aujourd'hui sera la **chaleur**.
...
### Discussion
Un brusque changement de densité optique devait montrer la température de fusion. La température de fusion Tm semble être d'environ 80°C (là où la courbe devient plus rapide). Nous pouvons utiliser cette donnée dans le calcul suivant:
