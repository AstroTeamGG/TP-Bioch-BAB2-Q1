...
Pour prouver que la levure digère bien le glucose, on peut utiliser le fait qu'elle produise du CO2 et le titrer en présence de NaOH. Si du CO2 a été produit, il y aura moins de NaOH que la quantité que nous avons initialement placée. Le NaOH fait une réaction acide-base classique avec le CO2.
...
Il va y avoir un échange de proton entre H2 CO3 et le OH-, ce qui va laisser l'ion spectateur Na+ se fixer sur le HCO3-. Donc pour chaque mole de CO2 produit, il y aura une quantité équimolaire de NaOH (OH-) qui sera consommée. On va donc titrer la quantité de NaOH restante avec du HCl comme titrant. De manière théorique, le rendement peut être calculé comme suit:
